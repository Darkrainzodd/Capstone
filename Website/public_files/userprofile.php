...
<html lang="en">
  <head>
    ...
    <title>Game Over X User Profile</title>
...
<center>
  ...
  <div class="page-header">
    <h2>Welcome: <?php echo $_SESSION["username"]; ?></h2><!-- RETRIEVE USERNAME FROM DATABASE -->
</div>
<div class="col-lg-12">

<div class="col-md-4">
	<img src="avatars/<?php echo $_SESSION['username']; ?>.jpg" width="150" height="150">
...
</div> <!-- THIS SHOULD BE THE USER'S IMAGE -->
...
<div id="aboutme_db"> <!-- THIS SHOULD READ FROM DATABASE, aboutme_db IS JUST A PLACE HOLDER. Could we add an edit link to update the info? -->
	Simple Guy living the simple gaming life.
	Games include:
	<p>game 1</p>
	<p>game 2</p>
	<p>game 3</p>
